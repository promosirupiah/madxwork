...
jQuery(function($) {
    ...
    $('ul.ayb-vmenu li:not(:first-child),ul.ayb-vmenu li li li:first-child,ul.ayb-vmenu>li>ul').each(function () { $(this).append('<div class="ayb-vmenu-separator"> </div><div class="ayb-vmenu-separator-bg"> </div>'); });
});
...
jQuery(function ($) {
    ...
    var bgimages = "url('http://cdn.madxartwork.com/images/object0.png'), ".split(",");
    ...
    header.css('background-image', "url('http://cdn.madxartwork.com/images/header.png')".replace(/(url\(['"]?)/i, "$1" + path));
